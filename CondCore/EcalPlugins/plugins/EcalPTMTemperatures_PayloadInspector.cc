 ...
 *******************************************************/
  ...
  public:
    EcalPTMTemperaturesPlot() : cond::payloadInspector::PlotImage<EcalPTMTemperatures>("Ecal PTM Temperatures - map ") {
      setSingleIov(true);
    }
...
PAYLOAD_INSPECTOR_MODULE(EcalPTMTemperatures) { PAYLOAD_INSPECTOR_CLASS(EcalPTMTemperaturesPlot); }