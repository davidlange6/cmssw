  ...
  namespace stage2 {
    namespace emtf {
      ...
      int TrailersBlockUnpacker::checkFormat(const Block& block) {
        ...
        if (payload.size() != 8) {
          errors += 1;
          edm::LogError("L1T|EMTF") << "Payload size in 'AMC Data Trailer' is different than expected";
        }

        //Check that each word is 16 bits
        if (GetHexBits(payload[0], 16, 31) != 0) {
          errors += 1;
          edm::LogError("L1T|EMTF") << "Payload[0] has more than 16 bits in 'AMC Data Trailer'";
        }
        if (GetHexBits(payload[1], 16, 31) != 0) {
          errors += 1;
          edm::LogError("L1T|EMTF") << "Payload[1] has more than 16 bits in 'AMC Data Trailer'";
        }
        if (GetHexBits(payload[2], 16, 31) != 0) {
          errors += 1;
          edm::LogError("L1T|EMTF") << "Payload[2] has more than 16 bits in 'AMC Data Trailer'";
        }
        if (GetHexBits(payload[3], 16, 31) != 0) {
          errors += 1;
          edm::LogError("L1T|EMTF") << "Payload[3] has more than 16 bits in 'AMC Data Trailer'";
        }
        if (GetHexBits(payload[3], 16, 31) != 0) {
          errors += 1;
          edm::LogError("L1T|EMTF") << "Payload[3] has more than 16 bits in 'AMC Data Trailer'";
        ...
        //Check Format
        if (GetHexBits(TR1a, 12, 15) != 15) {
          errors += 1;
          edm::LogError("L1T|EMTF") << "Format identifier bits in TR1a are incorrect";
        }
        if (GetHexBits(TR1b, 12, 15) != 15) {
          errors += 1;
          edm::LogError("L1T|EMTF") << "Format identifier bits in TR1b are incorrect";
        }
        if (GetHexBits(TR1c, 12, 15) != 15) {
          errors += 1;
          edm::LogError("L1T|EMTF") << "Format identifier bits in TR1c are incorrect";
        }
        if (GetHexBits(TR1d, 12, 15) != 15) {
          errors += 1;
          edm::LogError("L1T|EMTF") << "Format identifier bits in TR1d are incorrect";
        }
        if (GetHexBits(TR2a, 12, 15) != 14) {
          errors += 1;
          edm::LogError("L1T|EMTF") << "Format identifier bits in TR2a are incorrect";
        }
        if (GetHexBits(TR2b, 12, 15) != 14) {
          errors += 1;
          edm::LogError("L1T|EMTF") << "Format identifier bits in TR2b are incorrect";
        }
        if (GetHexBits(TR2c, 12, 15) != 14) {
          errors += 1;
          edm::LogError("L1T|EMTF") << "Format identifier bits in TR2c are incorrect";
        }
        if (GetHexBits(TR2d, 12, 15) != 14) {
          errors += 1;
          edm::LogError("L1T|EMTF") << "Format identifier bits in TR2d are incorrect";
        }
      ...
      bool TrailersBlockUnpacker::unpack(const Block& block, UnpackerCollections* coll) {
        ...
        for (int err = 0; err < checkFormat(block); err++)
          EventTrailer_.add_format_error();
