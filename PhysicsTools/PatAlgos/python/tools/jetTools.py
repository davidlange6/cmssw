...
def setupBTagging(process, jetSource, pfCandidates, explicitJTA, pvSource, svSource, elSource, muSource, runIVF, tightBTagNTkHits, loadStdRecoBTag, svClustering, fatJets, groomedFatJets,
    ...
    present_meta = discriminators.intersection(set(list(six.iterkeys(supportedMetaDiscr))))
...
class AddJetCollection(ConfigToolBase):
    ...
    def __init__(self):
        ...
        If this list is empty no btag discriminator information will be added to your new patJet collection.", allowedValues=(list(six.iterkeys(supportedBtagDiscr))+supportedMetaDiscr.keys()),Type=list)
...
class SwitchJetCollection(ConfigToolBase):
    ...
    def __init__(self):
        ...
        discriminator information will be added to your new patJet collection.", allowedValues=(list(six.iterkeys(supportedBtagDiscr))+supportedMetaDiscr.keys()),Type=list)
