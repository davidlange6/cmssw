...
// ----------------------------------------------------------------------------
//
ApvLatencyAnalysis::ApvLatencyAnalysis() : CommissioningAnalysis("ApvLatencyAnalysis"), latency_(sistrip::invalid_) {
  ;
}

// ----------------------------------------------------------------------------
//
void ApvLatencyAnalysis::reset() { latency_ = sistrip::invalid_; }
