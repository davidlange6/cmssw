...
EcalTBHodoscopeGeometry::EcalTBHodoscopeGeometry() : m_cellVec(nPlanes_ * nFibres_) {}

EcalTBHodoscopeGeometry::~EcalTBHodoscopeGeometry() {}

float EcalTBHodoscopeGeometry::getFibreLp(int plane, int fibre) {
...
float EcalTBHodoscopeGeometry::getFibreRp(int plane, int fibre) {
  if (plane < nPlanes_ && fibre < nFibres_) {
...
int EcalTBHodoscopeGeometry::getNPlanes() { return nPlanes_; }

int EcalTBHodoscopeGeometry::getNFibres() { return nFibres_; }

void EcalTBHodoscopeGeometry::newCell(
...
const EcalTBHodoscopeGeometry::fibre_pos EcalTBHodoscopeGeometry::fibrePos_[EcalTBHodoscopeGeometry::nPlanes_]
                                                                           [EcalTBHodoscopeGeometry::nFibres_] = {
                                                                               {
                                                                                   // Position is in mm
                                                                                   // FIBRES POSITIONS
                                                                                   //
...
std::vector<int> EcalTBHodoscopeGeometry::getFiredFibresInPlane(float xtr, int plane) {
