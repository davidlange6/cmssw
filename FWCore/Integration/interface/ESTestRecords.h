...
class ESTestRecordD
    : public edm::eventsetup::DependentRecordImplementation<
          ESTestRecordD, boost::mpl::vector<ESTestRecordF, ESTestRecordG, ESTestRecordH> > {};

class ESTestRecordB
    : public edm::eventsetup::DependentRecordImplementation<
          ESTestRecordB, boost::mpl::vector<ESTestRecordC, ESTestRecordD, ESTestRecordE> > {};
...
class ESTestRecordI
    : public edm::eventsetup::DependentRecordImplementation<ESTestRecordI,
                                                            boost::mpl::vector<ESTestRecordK> > {};

class ESTestRecordJ
    : public edm::eventsetup::DependentRecordImplementation<ESTestRecordJ,
                                                            boost::mpl::vector<ESTestRecordK> > {};
