...
namespace edmtest {
  ...
  public:
    ...
    virtual void analyze(edm::StreamID, edm::Event const& event,
  ...
  AssociationMapAnalyzer::AssociationMapAnalyzer(edm::ParameterSet const& pset) {
    ...
    associationMapToken1_ =
        consumes<AssocOneToOne>(pset.getParameter<edm::InputTag>("associationMapTag1"));
    associationMapToken2_ =
        consumes<AssocOneToOne>(pset.getParameter<edm::InputTag>("associationMapTag2"));
    associationMapToken3_ =
        consumes<AssocOneToValue>(pset.getParameter<edm::InputTag>("associationMapTag3"));
    associationMapToken4_ =
        consumes<AssocOneToValue>(pset.getParameter<edm::InputTag>("associationMapTag4"));
    associationMapToken5_ =
        consumes<AssocOneToMany>(pset.getParameter<edm::InputTag>("associationMapTag5"));
    associationMapToken6_ =
        consumes<AssocOneToManyWithQuality>(pset.getParameter<edm::InputTag>("associationMapTag6"));
    associationMapToken7_ =
        consumes<AssocOneToOneView>(pset.getParameter<edm::InputTag>("associationMapTag7"));
    associationMapToken8_ =
        consumes<AssocOneToOneView>(pset.getParameter<edm::InputTag>("associationMapTag8"));
  }

  void AssociationMapAnalyzer::analyze(edm::StreamID, edm::Event const& event,
