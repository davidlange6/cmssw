    ...
    desc.ifValue(
        ...
        "a" >> edm::ParameterDescription<int>(std::string("x"), 100, true, edm::Comment("test2")) or
            "b" >> (edm::ParameterDescription<double>("y1", true, edm::Comment("test3")) and
                    edm::ParameterDescription<double>(std::string("y2"), true,
                                                      edm::Comment(std::string("test4")))) or
            ...
            "e" >>
                edm::ParameterDescription<edm::ParameterSetDescription>(
            ...
            "g" >> edm::ParameterDescription<std::vector<edm::ParameterSet> >(
                       std::string("vpset2"), nestedDesc, true, vectorOfPSets,
                       edm::Comment("test8")) or
