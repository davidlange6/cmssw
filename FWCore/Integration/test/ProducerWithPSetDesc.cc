...
namespace edmtest {
  ...
  void ProducerWithPSetDesc::fillDescriptions(edm::ConfigurationDescriptions& descriptions) {
    ...
    edm::ParameterDescription<std::vector<edm::ParameterSet>> test104(std::string("test104"), barx, false,
                                                                      defaultVPSet104);
    iDesc.addNode(test104);

    std::vector<edm::ParameterSet> defaultVPSet105;
    edm::ParameterDescription<std::vector<edm::ParameterSet>> test105(std::string("test105"), barx, false,
                                                                      defaultVPSet105);
    ...
    std::unique_ptr<edm::ParameterDescriptionNode> wnode2 =
        std::make_unique<edm::ParameterWildcard<edm::ParameterSetDescription>>("*", edm::RequireAtLeastOne, true,
                                                                               wSet1);
    ...
    std::unique_ptr<edm::ParameterDescriptionNode> wnode4 =
        std::make_unique<edm::ParameterWildcard<std::vector<edm::ParameterSet>>>("*", edm::RequireAtLeastOne, true,
                                                                                 wSet1);
    ...
    allowedLabelsPset.labelsFromOptionalUntracked<std::vector<edm::ParameterSet>>(std::string("testWithVectorOfSets"),
                                                                                  true, bar);
