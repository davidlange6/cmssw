...
namespace edmtest {
  ProducerWithPSetDesc::ProducerWithPSetDesc(edm::ParameterSet const& ps) {
    ...
    vLuminosityBlockID =
        ps.getParameter<std::vector<edm::LuminosityBlockID>>("vLuminosityBlockIDv1");
    assert(vLuminosityBlockID.empty());
    vLuminosityBlockID =
        ps.getParameter<std::vector<edm::LuminosityBlockID>>("vLuminosityBlockIDv2");
    assert(vLuminosityBlockID[0] == edm::LuminosityBlockID(1000, 1100));
    vLuminosityBlockID =
        ps.getParameter<std::vector<edm::LuminosityBlockID>>("vLuminosityBlockIDv3");
    assert(vLuminosityBlockID[0] == edm::LuminosityBlockID(1000, 1100));
    assert(vLuminosityBlockID[1] == edm::LuminosityBlockID(10000, 11000));
    vLuminosityBlockID =
        ps.getParameter<std::vector<edm::LuminosityBlockID>>("vLuminosityBlockIDv4");
    assert(vLuminosityBlockID[0] == edm::LuminosityBlockID(1000, 1100));
    assert(vLuminosityBlockID[1] == edm::LuminosityBlockID(10000, 11000));
    ...
    if (testingAutoGeneratedCfi) {
      assert(psetAllowed.getParameter<std::vector<std::string>>("testAllowedLabels") ==
             std::vector<std::string>());
      assert(psetAllowed.getUntrackedParameter<std::vector<std::string>>(
                 "testAllowedLabelsUntracked") == std::vector<std::string>());
  ...
  void ProducerWithPSetDesc::fillDescriptions(edm::ConfigurationDescriptions& descriptions) {
    ...
    edm::ParameterDescription<std::vector<edm::ParameterSet>> test103(std::string("test103"), barx,
                                                                      true);
    iDesc.addOptionalNode(test103, false);

    std::vector<edm::ParameterSet> defaultVPSet104;
    defaultVPSet104.push_back(edm::ParameterSet());
    edm::ParameterDescription<std::vector<edm::ParameterSet>> test104(std::string("test104"), barx,
                                                                      false, defaultVPSet104);
    iDesc.addNode(test104);

    std::vector<edm::ParameterSet> defaultVPSet105;
    edm::ParameterDescription<std::vector<edm::ParameterSet>> test105(std::string("test105"), barx,
    ...
    deeplyNested.ifValueOptional(
        edm::ParameterDescription<int>("ndiswitch", 1, true),
    ...
    pn = switchPset.ifValue(
        edm::ParameterDescription<int>("iswitch", 1, true),
    ...
    switchPset
        .ifValue(
            edm::ParameterDescription<bool>("addTeVRefits", true, true),
    ...
    xorPset.addNode(edm::ParameterDescription<std::string>("name3", "11", true) xor
                    edm::ParameterDescription<unsigned int>("name4", 11U, true) xor test101 xor
                    test103);
    ...
    ifExistsPset.ifExistsOptional(edm::ParameterDescription<unsigned int>("y1", 11U, true),
                                  edm::ParameterDescription<std::string>("y2", "11", true), false);
    ...
    allowedLabelsPset.labelsFromOptionalUntracked<unsigned>(
        std::string("testOptAllowedLabelsUntracked"), false);
