...
namespace edmtest {
  ...
  void ThingWithMergeProducer::beginLuminosityBlockProduce(edm::LuminosityBlock& lb,
  ...
  void ThingWithMergeProducer::beginLuminosityBlock(edm::LuminosityBlock const& lb,
                                                    edm::EventSetup const&) {
    for (Iter iter = labelsToGet_.begin(), ie = labelsToGet_.end(); iter != ie; ++iter) {
      edm::Handle<Thing> h;
