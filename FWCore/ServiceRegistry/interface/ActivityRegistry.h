...
/**\class ActivityRegistry ActivityRegistry.h FWCore/ServiceRegistry/interface/ActivityRegistry.h
 ...
 Usage:
    Services can connect to the signals distributed by the ActivityRegistry in order to monitor the
...
#define AR_WATCH_USING_METHOD_2(method)                                                          \
  ...
  void method(TClass* iObject, TMethod iMethod) {                                                \
    method(                                                                                      \
        std::bind(std::mem_fn(iMethod), iObject, std::placeholders::_1, std::placeholders::_2)); \
  }
...
namespace edm {
  ...
  public:
    ...
    typedef signalslot::Signal<void(StreamContext const&, ModuleCallingContext const&)>
    ...
    /// signal is emitted after the Run has been created by the InputSource but before any modules
    /// have seen the Run
    ...
    /// signal is emitted after the Event has been created by the InputSource but before any
    /// modules have seen the Event
    ...
    typedef signalslot::Signal<void(StreamContext const&, PathContext const&, HLTPathStatus const&)>
        PostPathEvent;
    ...
    // OLD DELETE THIS
    typedef signalslot::ObsoleteSignal<void(LuminosityBlockID const&, Timestamp const&)>
        PreBeginLumi;
    /// signal is emitted after the Lumi has been created by the InputSource but before any
    /// modules have seen the Lumi
    ...
    // OLD DELETE THIS
    typedef signalslot::ObsoleteSignal<void(LuminosityBlock const&, EventSetup const&)>
        PostBeginLumi;
    ...
    // OLD DELETE THIS
    /// signal is emitted after all modules have finished for the Path for an event
    typedef signalslot::ObsoleteSignal<void(std::string const&, HLTPathStatus const&)>
        PostProcessPath;
    ...
    */
    ...
    /// signal is emitted before the module starts processing the Event and before prefetching has
    /// started
    typedef signalslot::Signal<void(StreamContext const&, ModuleCallingContext const&)>
    ...
    /// signal is emitted before the module starts processing the Event and after prefetching has
    /// finished
    typedef signalslot::Signal<void(StreamContext const&, ModuleCallingContext const&)>
    ...
    /// signal is emitted after the module starts processing the Event and before a delayed get
    /// has started
    typedef signalslot::Signal<void(StreamContext const&, ModuleCallingContext const&)>
    ...
    /// signal is emitted after the module starts processing the Event and after a delayed get has
    /// finished
    typedef signalslot::Signal<void(StreamContext const&, ModuleCallingContext const&)>
    ...
    /// signal is emitted after the module starts processing the Event, after a delayed get has
    /// started, and before a source read
    typedef signalslot::Signal<void(StreamContext const&, ModuleCallingContext const&)>
    ...
    /// signal is emitted after the module starts processing the Event, after a delayed get has
    /// started, and after a source read
    typedef signalslot::Signal<void(StreamContext const&, ModuleCallingContext const&)>
