...
namespace edm {
  ...
  ParentContext::ParentContext(GlobalContext const* global) : type_(Type::kGlobal) {
  ...
  ParentContext::ParentContext(ModuleCallingContext const* module) : type_(Type::kModule) {
  ...
  ParentContext::ParentContext(StreamContext const* stream) : type_(Type::kStream) {
