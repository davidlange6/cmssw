...
void testmakepset::fileinpathAux() {
  ...
  "    fip = cms.FileInPath('FWCore/PyBiond11ParameterSet/test/fip.txt'),\n"
  ...
  std::string tmpout = fullpath.substr(0, fullpath.find("FWCore/PyBind11ParameterSet/test/fip.txt")) + "tmp.py";
