...
void __class__::produce(edm::Event& iEvent, const edm::EventSetup& iSetup) {
  ...
  */
  ...
  @example_myparticle @example_myparticle  // if the number of electrons or muons is 4 (or 2 and
                                           // 2), costruct a new particle
    ...
    @example_myparticle @example_myparticle  // loop over muons, sum over p4s and charges. Later
                                             // same for electrons
        @example_myparticle for (MuonCollection::const_iterator muon = muons->begin();
                                 muon != muons->end(); ++muon) {
    ...
    @example_myparticle
        @example_myparticle for (PixelMatchGsfElectronCollection::const_iterator electron =
                                     electrons->begin();
    ...
    @example_myparticle @example_myparticle  // create a particle with momentum and charge from
                                             // muons and electrons
