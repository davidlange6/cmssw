...
namespace edm {
  ...
  ParameterDescriptionNode* ParameterSetDescription::addNode(
      std::unique_ptr<ParameterDescriptionNode> node, bool optional, bool writeToCfi) {
  ...
  void ParameterSetDescription::validate(ParameterSet& pset) const {
    ...
    for_all(entries_, std::bind(&ParameterSetDescription::validateNode, _1, std::ref(pset),
  ...
  void ParameterSetDescription::writeCfi(std::ostream& os, bool startWithComma,
    ...
    for_all(entries_, std::bind(&ParameterSetDescription::writeNode, _1, std::ref(os),
                                std::ref(startWithComma), indentation, std::ref(wroteSomething)));
  ...
  void ParameterSetDescription::print(std::ostream& os, DocFormatHelper& dfh) const {
    ...
    dfh.setCounter(0);
    for_all(entries_,
            std::bind(&ParameterSetDescription::printNode, _1, std::ref(os), std::ref(dfh)));
  ...
  void ParameterSetDescription::throwIllegalParameters(
    ...
    std::stringstream ss;
    for (std::set<std::string>::const_iterator iter = diffNames.begin(), iEnd = diffNames.end();
         iter != iEnd; ++iter) {
      ss << " '" << *iter << "'\n";
    }
  ...
  void ParameterSetDescription::writeNode(SetDescriptionEntry const& entry, std::ostream& os,
  ...
  void ParameterSetDescription::printNode(SetDescriptionEntry const& entry, std::ostream& os,
                                          DocFormatHelper& dfh) {
    if (dfh.pass() < 2) {
  ...
  void ParameterSetDescription::throwIfLabelsAlreadyUsed(std::set<std::string> const& nodeLabels) {
    ...
    std::insert_iterator<std::set<std::string> > insertIter(duplicateLabels,
                                                            duplicateLabels.begin());
    std::set_intersection(nodeLabels.begin(), nodeLabels.end(), usedLabels_.begin(),
  ...
  void ParameterSetDescription::throwIfWildcardCollision(
    ...
    if (!nodeWildcardTypes.empty()) {
      ...
      std::insert_iterator<std::set<ParameterTypes> > insertIter1(duplicateTypes1,
                                                                  duplicateTypes1.begin());
    ...
    if (!typesUsedForWildcards_.empty()) {
      ...
      std::insert_iterator<std::set<ParameterTypes> > insertIter2(duplicateTypes2,
                                                                  duplicateTypes2.begin());
