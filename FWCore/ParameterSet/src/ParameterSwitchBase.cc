...
namespace edm {
  ...
  void ParameterSwitchBase::insertAndCheckLabels(std::string const& switchLabel, std::set<std::string>& usedLabels,
  ...
  void ParameterSwitchBase::printBase(std::ostream& os, bool optional, bool writeToCfi, DocFormatHelper& dfh,
                                      std::string const& switchLabel, bool isTracked,
  ...
  void ParameterSwitchBase::printNestedContentBase(std::ostream& os, DocFormatHelper& dfh, DocFormatHelper& new_dfh,
  ...
  void ParameterSwitchBase::printCase(std::pair<bool, value_ptr<ParameterDescriptionNode> > const& p, std::ostream& os,
  ...
  void ParameterSwitchBase::printCase(std::pair<int, value_ptr<ParameterDescriptionNode> > const& p, std::ostream& os,
                                      bool /*optional*/, DocFormatHelper& dfh, std::string const& switchLabel) {
    if (dfh.pass() == 0) {
      p.second->print(os, false, true, dfh);
    }
