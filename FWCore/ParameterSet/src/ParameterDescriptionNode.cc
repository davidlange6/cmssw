...
namespace edm {
  ...
  void ParameterDescriptionNode::print(std::ostream& os, bool optional, bool writeToCfi,
  ...
  void ParameterDescriptionNode::printNestedContent(std::ostream& os, bool optional,
                                                    DocFormatHelper& dfh) const {
    if (hasNestedContent()) {
      dfh.incrementCounter();
