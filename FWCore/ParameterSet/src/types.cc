...
bool edm::encode(std::string& to, std::vector<unsigned long long> const& from) {
  ...
  std::string converted;
  for (std::vector<unsigned long long>::const_iterator b = from.begin(), e = from.end(); b != e;
       ++b) {
    if (!encode(converted, *b)) {
      return false;
    }
...
bool edm::encode(std::string& to, std::vector<edm::LuminosityBlockID> const& from) {
  std::vector<std::string> strings;
  for (std::vector<edm::LuminosityBlockID>::const_iterator idItr = from.begin(),
                                                           idItrEnd = from.end();
       idItr != idItrEnd; ++idItr) {
...
bool edm::decode(edm::LuminosityBlockRange& to, std::string const& from) {
  ...
  to = edm::LuminosityBlockRange(begin.run(), begin.luminosityBlock(), end.run(),
                                 end.luminosityBlock());
  return true;
...
bool edm::encode(std::string& to, std::vector<edm::LuminosityBlockRange> const& from) {
  std::vector<std::string> strings;
  for (std::vector<edm::LuminosityBlockRange>::const_iterator idItr = from.begin(),
                                                              idItrEnd = from.end();
       idItr != idItrEnd; ++idItr) {
...
bool edm::decode(edm::EventRange& to, std::string const& from) {
  ...
  to = edm::EventRange(begin.run(), begin.luminosityBlock(), begin.event(), end.run(),
                       end.luminosityBlock(), end.event());
  return true;
