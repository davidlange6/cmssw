...
namespace edm {
  ...
  ParameterDescriptionBase::ParameterDescriptionBase(char const* iLabel, ParameterTypes iType,
  ...
  void ParameterDescriptionBase::print_(std::ostream& os, bool optional, bool writeToCfi,
  ...
  void ParameterDescriptionBase::printNestedContent_(std::ostream& os, bool /*optional*/,
                                                     DocFormatHelper& dfh) const {
