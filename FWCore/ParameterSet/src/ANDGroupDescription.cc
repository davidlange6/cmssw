...
namespace edm {
  ...
  void ANDGroupDescription::validate_(ParameterSet& pset, std::set<std::string>& validatedLabels,
                                      bool optional) const {
  ...
  void ANDGroupDescription::print_(std::ostream& os, bool optional, bool writeToCfi,
  ...
  int ANDGroupDescription::howManyXORSubNodesExist_(ParameterSet const& pset) const {
