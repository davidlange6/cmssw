...
namespace edm {
  ...
  AllowedLabelsDescriptionBase::AllowedLabelsDescriptionBase(std::string const& label, ParameterTypes iType,
                                                             bool isTracked)
  ...
  void AllowedLabelsDescriptionBase::validate_(ParameterSet& pset, std::set<std::string>& validatedLabels,
                                               bool optional) const {
    ...
    if (parameterHoldingLabels_.exists(pset)) {
      ...
      for_all(allowedLabels, std::bind(&AllowedLabelsDescriptionBase::validateAllowedLabel_, this,
                                       std::placeholders::_1, std::ref(pset), std::ref(validatedLabels)));
    }
  }

  void AllowedLabelsDescriptionBase::writeCfi_(std::ostream& os, bool& startWithComma, int indentation,
