...
FWCore/ParameterSet/interface/ParameterSetDescriptionFillerBase.h
 ...
 Usage:
    This base class provides an abstract interface for filling a ParameterSetDescription object.
This allows one to used by the
ParameterSetDescriptionFillerPluginFactory to load a component of any type (e.g. cmsRun Source,
cmsRun EDProducer or even a tracking plugin)
