...
namespace edm {
  ...
  protected:
    ...
    ParameterDescriptionBase(std::string const& iLabel, ParameterTypes iType, bool isTracked,
                             bool hasDefault, Comment const& iComment);

    ParameterDescriptionBase(char const* iLabel, ParameterTypes iType, bool isTracked,
                             bool hasDefault, Comment const& iComment);
