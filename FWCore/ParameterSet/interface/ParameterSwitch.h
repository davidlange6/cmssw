...
namespace edm {
  ...
  public:
    ...
    typedef typename std::map<T, edm::value_ptr<ParameterDescriptionNode> >::const_iterator
        CaseMapConstIter;
  ...
  private:
    void checkAndGetLabelsAndTypes_(std::set<std::string>& usedLabels,
      ...
      for_all(cases_, std::bind(&ParameterSwitch::checkCaseLabels, std::placeholders::_1,
      ...
      insertAndCheckTypes(switch_.type(), caseParameterTypes, caseWildcardTypes, parameterTypes,
                          wildcardTypes);
    ...
    void writeCfi_(std::ostream& os, bool& startWithComma, int indentation,
    ...
    void print_(std::ostream& os, bool optional, bool writeToCfi,
    ...
    void printNestedContent_(std::ostream& os, bool optional, DocFormatHelper& dfh) const override {
      ...
      for_all(cases_,
              std::bind(&ParameterSwitchBase::printCaseT<T>, std::placeholders::_1, std::ref(os),
                        optional, std::ref(new_dfh), std::cref(switch_.label())));
