...
namespace edm {
  ...
  public:
    ...
    ParameterDescriptionNode* addOptionalNode(ParameterDescriptionNode const& node,
                                              bool writeToCfi);
    ParameterDescriptionNode* addOptionalNode(std::unique_ptr<ParameterDescriptionNode> node,
                                              bool writeToCfi);
  ...
  private:
    template <typename T, typename U>
    ParameterDescriptionBase* add(U const& iLabel, T const& value, bool isTracked, bool isOptional,
                                  bool writeToCfi);

    template <typename T, typename U>
    ParameterDescriptionBase* add(U const& iLabel, bool isTracked, bool isOptional,
                                  bool writeToCfi);
    ...
    ParameterDescriptionNode* addNode(std::unique_ptr<ParameterDescriptionNode> node, bool optional,
                                      bool writeToCfi);
    ...
    template <typename T, typename U>
    ParameterDescriptionNode* labelsFrom(U const& iLabel, bool isTracked, bool optional,
                                         bool writeToCfi);
    ...
    static void writeNode(SetDescriptionEntry const& entry, std::ostream& os, bool& startWithComma,
...
namespace edm {
  ...
  template <typename T, typename U>
  ParameterDescriptionBase* ParameterSetDescription::add(U const& iLabel, T const& value,
  ...
  template <typename T, typename U>
  ParameterDescriptionBase* ParameterSetDescription::add(U const& iLabel, bool isTracked,
                                                         bool isOptional, bool writeToCfi) {
    std::unique_ptr<ParameterDescriptionNode> node =
  ...
  ParameterDescriptionBase* ParameterSetDescription::addVPSet(
      ...
      std::vector<ParameterSet> const& defaults, bool isTracked, bool isOptional, bool writeToCfi) {
    std::unique_ptr<ParameterDescriptionNode> node =
        std::make_unique<ParameterDescription<std::vector<ParameterSet>>>(iLabel, validator,
                                                                          isTracked, defaults);
    ParameterDescriptionNode* pnode = addNode(std::move(node), isOptional, writeToCfi);
    return static_cast<ParameterDescriptionBase*>(pnode);
  }
  ...
  template <typename U>
  ParameterDescriptionBase* ParameterSetDescription::addVPSet(
      U const& iLabel, ParameterSetDescription const& validator, bool isTracked, bool isOptional,
      bool writeToCfi) {
    std::unique_ptr<ParameterDescriptionNode> node =
        std::make_unique<ParameterDescription<std::vector<ParameterSet>>>(iLabel, validator,
                                                                          isTracked);
  ...
  ParameterDescriptionNode* ParameterSetDescription::ifValue(
      ...
      std::unique_ptr<ParameterDescriptionCases<T>> cases, bool optional, bool writeToCfi) {
  ...
  template <typename T, typename U>
  ParameterDescriptionNode* ParameterSetDescription::labelsFrom(U const& iLabel, bool isTracked,
                                                                bool optional, bool writeToCfi) {
