...
namespace edm {
  ...
  public:
    ...
    AllowedLabelsDescription(std::string const& label, ParameterSetDescription const& value,
                             bool isTracked);

    AllowedLabelsDescription(char const* label, ParameterSetDescription const& value,
                             bool isTracked);

    ParameterDescriptionNode* clone() const override;

  private:
    void printNestedContent_(std::ostream& os, bool optional,
