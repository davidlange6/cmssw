...
namespace testParameterSetDescription {
  ...
  void testDesc(edm::ParameterDescriptionNode const& node,
                edm::ParameterSetDescription const& psetDesc, edm::ParameterSet& pset, bool exists,
                bool validates) {
  ...
  void testWildcards() {
    ...
    {
      edm::ParameterSetDescription set;
      edm::ParameterWildcard<edm::ParameterSetDescription> w(std::string("*"),
    ...
    {
      edm::ParameterSetDescription set;
      edm::ParameterWildcard<std::vector<edm::ParameterSet>> w(std::string("*"),
                                                               edm::RequireZeroOrMore, true);
      set.addNode(w);
      edm::ParameterSet pset;
      testDesc(w, set, pset, true, true);
  ...
  void testIfExists() {
    ...
    edm::ParameterSetDescription psetDesc6;
    psetDesc6.add<double>("x0", 1.0);
    std::unique_ptr<edm::ParameterDescriptionNode> node6(std::make_unique<edm::IfExistsDescription>(
        edm::ParameterWildcard<double>("*", edm::RequireAtLeastOne, true),
        (edm::ParameterDescription<unsigned>("x2", 101U, true) and
  ...
  void testAllowedLabels() {
    ...
    edm::ParameterSetDescription psetDesc5;
    psetDesc5.labelsFrom<edm::ParameterSetDescription>("allowedLabelsA",
                                                       edm::ParameterSetDescription());
    ...
    psetDesc9.labelsFrom<edm::ParameterSetDescription>(std::string("allowedLabelsA"),
                                                       edm::ParameterSetDescription());
    ...
    // necessary to test the vector<ParameterSet> case
    {
      ...
      psetDesc15.labelsFrom<std::vector<edm::ParameterSet>>("allowedLabelsC",
                                                            edm::ParameterSetDescription());
      ...
      psetDesc19.labelsFrom<std::vector<edm::ParameterSet>>(std::string("allowedLabelsC"),
                                                            edm::ParameterSetDescription());
      psetDesc20.labelsFrom<std::vector<edm::ParameterSet>>(std::string("allowedLabelsC"),
                                                            psetDesc7);
...
int main(int, char**) try {
  std::cout << "Running TestFWCoreParameterSetDescription from parameterSetDescription_t.cc"
            << std::endl;
