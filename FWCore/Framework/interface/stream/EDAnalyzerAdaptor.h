...
namespace edm {
  namespace stream {
    ...
    private:
      ...
      void streamEndRunSummary(EDAnalyzerBase* iProd, edm::Run const& iRun,
      ...
      void streamEndLuminosityBlockSummary(EDAnalyzerBase* iProd, edm::LuminosityBlock const& iLumi,
                                           edm::EventSetup const& iES) override final {
      ...
      void doEndLuminosityBlock(LuminosityBlockPrincipal const& lbp, EventSetup const& c,
        ...
        if (T::HasAbility::kLuminosityBlockCache or T::HasAbility::kLuminosityBlockSummaryCache) {
          ...
          typename T::LuminosityBlockContext lc(m_lumis[li].get(), m_runs[ri].get(),
                                                m_global.get());
          MyGlobalLuminosityBlockSummary::globalEndLuminosityBlock(lb, c, &lc,
      ...
      typename impl::choose_shared_vec<typename T::LuminosityBlockSummaryCache>::type
          m_lumiSummaries;
