...
namespace edm {
  ...
  namespace stream {
    ...
    struct CallGlobalRunImpl {
      static void beginRun(edm::Run const& iRun, edm::EventSetup const& iES,
      ...
      static void endRun(edm::Run const& iRun, edm::EventSetup const& iES,
    ...
    struct CallGlobalRunImpl<T, false> {
      static void beginRun(edm::Run const&, edm::EventSetup const&, typename T::GlobalCache const*,
                           impl::dummy_ptr) {}
    ...
    struct CallGlobalRunSummaryImpl {
      ...
      template <typename B>
      static void streamEndRunSummary(B* iProd, edm::Run const& iRun, edm::EventSetup const& iES,
                                      typename T::RunSummaryCache* iCache) {
        static_cast<T*>(iProd)->endRunSummary(iRun, iES, iCache);
      }

      static void globalEndRun(edm::Run const& iRun, edm::EventSetup const& iES,
                               typename T::RunContext const* iContext,
                               typename T::RunSummaryCache* iCache) {
    ...
    struct CallGlobalRunSummaryImpl<T, false> {
      static void beginRun(edm::Run const&, edm::EventSetup const&, typename T::RunContext const*,
                           impl::dummy_ptr) {}
      static void streamEndRunSummary(void* iProd, edm::Run const&, edm::EventSetup const&,
                                      typename T::RunSummaryCache const* iCache) {}
      static void globalEndRun(edm::Run const&, edm::EventSetup const&,
                               typename T::RunContext const*, typename T::RunSummaryCache*) {}
    };
    ...
    struct CallGlobalLuminosityBlockImpl {
      static void beginLuminosityBlock(
          edm::LuminosityBlock const& Lumi, edm::EventSetup const& iES,
          typename T::RunContext const* iRC,
      ...
      static void endLuminosityBlock(edm::LuminosityBlock const& Lumi, edm::EventSetup const& iES,
    ...
    struct CallGlobalLuminosityBlockImpl<T, false> {
      static void beginLuminosityBlock(edm::LuminosityBlock const&, edm::EventSetup const&,
                                       typename T::RunContext const*, impl::dummy_ptr) {}
      static void set(void* iProd, typename T::LuminosityBlockCache const* iCache) {}
      static void endLuminosityBlock(edm::LuminosityBlock const&, edm::EventSetup const&,
                                     typename T::LuminosityBlockContext const*) {}
    };
    template <typename T>
    using CallGlobalLuminosityBlock =
        CallGlobalLuminosityBlockImpl<T, T::HasAbility::kLuminosityBlockCache>;
    ...
    struct CallGlobalLuminosityBlockSummaryImpl {
      ...
      template <typename B>
      static void streamEndLuminosityBlockSummary(B* iProd, edm::LuminosityBlock const& iLumi,
    ...
    struct CallGlobalLuminosityBlockSummaryImpl<T, false> {
      static void beginLuminosityBlock(edm::LuminosityBlock const&, edm::EventSetup const&,
                                       typename T::LuminosityBlockContext const*, impl::dummy_ptr) {
      }
      static void streamEndLuminosityBlockSummary(void* iProd, edm::LuminosityBlock const&,
    ...
    struct CallBeginRunProduceImpl {
      static void produce(edm::Run& iRun, edm::EventSetup const& iES,
                          typename T::RunContext const* iRC) {
    ...
    struct CallEndRunProduceImpl {
      static void produce(edm::Run&, edm::EventSetup const&, typename T::RunContext const*,
    ...
    struct CallEndRunProduceImpl<T, true, false> {
      static void produce(edm::Run& iRun, edm::EventSetup const& iES,
                          typename T::RunContext const* iRC, typename T::RunSummaryCache const*) {
    ...
    template <typename T>
    using CallEndRunProduce =
        CallEndRunProduceImpl<T, T::HasAbility::kEndRunProducer, T::HasAbility::kRunSummaryCache>;
    ...
    struct CallBeginLuminosityBlockProduceImpl {
      static void produce(edm::LuminosityBlock& Lumi, edm::EventSetup const& iES,
                          typename T::LuminosityBlockContext const* iRC) {
    ...
    struct CallEndLuminosityBlockProduceImpl {
      static void produce(edm::LuminosityBlock&, edm::EventSetup const&,
                          typename T::LuminosityBlockContext const*,
    ...
    using CallEndLuminosityBlockProduce =
        CallEndLuminosityBlockProduceImpl<T, T::HasAbility::kEndLuminosityBlockProducer,
