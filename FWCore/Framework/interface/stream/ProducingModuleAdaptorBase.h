...
//
/**\class edm::stream::ProducingModuleAdaptorBase ProducingModuleAdaptorBase.h
...
namespace edm {
  ...
  namespace stream {
    ...
    private:
      ...
      const ProducingModuleAdaptorBase& operator=(const ProducingModuleAdaptorBase&) =
          delete;  // stop default
      ...
      void doStreamEndLuminosityBlock(StreamID id, LuminosityBlockPrincipal const& ep,
                                      EventSetup const& c, ModuleCallingContext const*);
      virtual void streamEndLuminosityBlockSummary(T*, edm::LuminosityBlock const&,
