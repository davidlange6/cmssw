...
namespace edm {
  ...
  namespace stream {
    namespace impl {
      ...
      private:
        virtual void endLuminosityBlockSummary(edm::LuminosityBlock const&, edm::EventSetup const&,
                                               C*) const = 0;
      };
      ...
      public:
        ...
        /// static void globalBeginRunProduce(edm::Run&, edm::EventSetup const&, RunContext
        /// const* );
      };
      ...
      private:
        /// requires the following be defined in the inheriting class
        /// static void globalBeginLuminosityBlockProduce(edm::LuminosityBlock&, edm::EventSetup
        /// const&, LuminosityBlockContext const*)
      };
      ...
      private:
        /// requires the following be defined in the inheriting class
        /// static void globalEndLuminosityBlockProduce(edm::LuminosityBlock&, edm::EventSetup
        /// const&, LuminosityBlockContext const*)
      };
    }
  }
