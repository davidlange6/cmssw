  ...
  namespace eventsetup {
    ...
    private:
      ...
      void setPostConstruction(DataProxyProvider* iProv, const edm::ParameterSet& iPSet) const {
        // The 'appendToDataLabel' parameter was added very late in the development cycle and
        // since
        // the ParameterSet is not sent to the base class we must set the value after
        // construction
