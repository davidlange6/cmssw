  ...
  public:
    ...
    static GlobalContext makeGlobalContext(MyPrincipal const& principal,
      ...
      return GlobalContext(GlobalContext::Transition::kBeginRun,
                           LuminosityBlockID(principal.run(), 0), principal.index(),
  ...
  public:
    ...
    static GlobalContext makeGlobalContext(MyPrincipal const& principal,
      ...
      return GlobalContext(GlobalContext::Transition::kEndRun,
                           LuminosityBlockID(principal.run(), 0), principal.index(),
                           LuminosityBlockIndex::invalidLuminosityBlockIndex(), principal.endTime(),
                           processContext);
    }
  ...
  public:
    ...
    static GlobalContext makeGlobalContext(MyPrincipal const& principal,
      ...
      return GlobalContext(GlobalContext::Transition::kBeginLuminosityBlock, principal.id(),
                           principal.runPrincipal().index(), principal.index(),
                           principal.beginTime(), processContext);
    }
