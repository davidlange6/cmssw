...
namespace edm {
  ...
  public:
    SubProcess(ParameterSet& parameterSet, ParameterSet const& topLevelParameterSet,
    ...
    void doBeginRunAsync(WaitingTaskHolder iHolder, RunPrincipal const& principal,
                         IOVSyncValue const& ts);

    void doEndRunAsync(WaitingTaskHolder iHolder, RunPrincipal const& principal,
    ...
    void doStreamBeginRunAsync(WaitingTaskHolder iHolder, unsigned int iID,
                               RunPrincipal const& principal, IOVSyncValue const& ts);

    void doStreamEndRunAsync(WaitingTaskHolder iHolder, unsigned int iID,
                             RunPrincipal const& principal, IOVSyncValue const& ts,
                             bool cleaningUpAfterException);

    void doStreamBeginLuminosityBlockAsync(WaitingTaskHolder iHolder, unsigned int iID,
                                           LuminosityBlockPrincipal const& principal,
                                           IOVSyncValue const& ts);

    void doStreamEndLuminosityBlockAsync(WaitingTaskHolder iHolder, unsigned int iID,
                                         LuminosityBlockPrincipal const& principal,
                                         IOVSyncValue const& ts, bool cleaningUpAfterException);
  ...
  private:
    ...
    void endLuminosityBlock(LuminosityBlockPrincipal const& lb, IOVSyncValue const& ts,
                            bool cleaningUpAfterException);

    void propagateProducts(BranchType type, Principal const& parentPrincipal,
