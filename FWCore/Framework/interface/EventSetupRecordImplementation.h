...
/**\class EventSetupRecordImplementation EventSetupRecordImplementation.h
 ...
 Usage:
    This class handles implementing the necessary 'meta data' methods for a Record. To use the
 class, a new Record type should
 inherit from EventSetupRecordImplementation and pass itself as the argument to the template
...
namespace edm {
  namespace eventsetup {
    ...
    public:
      ...
      virtual EventSetupRecordKey key() const { return EventSetupRecordKey::makeKey<T>(); }
