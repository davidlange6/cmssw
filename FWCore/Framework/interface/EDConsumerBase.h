...
namespace edm {
  ...
  public:
    ...
    ///\return true if the product corresponding to the index was registered via consumes or
    /// mayConsume call
  ...
  private:
    unsigned int recordConsumes(BranchType iBranch, TypeToGet const& iType,
    ...
    struct TokenLookupInfo {
      TokenLookupInfo(edm::TypeID const& iID, ProductResolverIndex iIndex, bool skipCurrentProcess,
                      BranchType iBranch)
    ...
    struct LabelPlacement {
      LabelPlacement(unsigned int iStartOfModuleLabel, unsigned short iDeltaToProductInstance,
    ...
    std::array<std::vector<ProductResolverIndexAndSkipBit>, edm::NumBranchTypes>
