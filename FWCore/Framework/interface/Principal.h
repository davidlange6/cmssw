...
namespace edm {
  ...
  public:
    ...
    typedef boost::filter_iterator<FilledProductPtr, ProductResolverCollection::const_iterator>
        const_iterator;
    ...
    Principal(std::shared_ptr<ProductRegistry const> reg,
              ...
              ProcessConfiguration const& pc, BranchType bt, HistoryAppender* historyAppender,
    ...
    void fillPrincipal(ProcessHistoryID const& hist, ProcessHistoryRegistry const& phr,
    ...
    const_iterator begin() const {
      return boost::make_filter_iterator<FilledProductPtr>(productResolvers_.begin(),
                                                           productResolvers_.end());
    }
    const_iterator end() const {
      return boost::make_filter_iterator<FilledProductPtr>(productResolvers_.end(),
                                                           productResolvers_.end());
    }
  ...
  private:
    ...
    ProductData const* findProductByLabel(KindOfType kindOfType, TypeID const& typeID,
