...
namespace edm {
  ...
  public:
    ...
    explicit EventProcessor(std::shared_ptr<ParameterSet> parameterSet,//std::string const& config,
    ...
    EventProcessor(std::shared_ptr<ParameterSet> parameterSet,//std::string const& config,
    ...
    EventProcessor(std::shared_ptr<ParameterSet> parameterSet, bool isPython);//std::string const& config, bool isPython);
