  ...
  namespace eventsetup {
    ...
    struct ModuleMakerTraits {
      ...
      static void addTo(EventSetupProvider& iProvider,
                        std::shared_ptr<DataProxyProvider> iComponent, ParameterSet const&, bool);
    ...
    typedef edmplugin::PluginFactory<edm::eventsetup::ComponentMakerBase<ModuleMakerTraits>*()>
        ModulePluginFactory;
  }
}

#define DEFINE_FWK_EVENTSETUP_MODULE(type)                                                    \
  DEFINE_EDM_PLUGIN(edm::eventsetup::ModulePluginFactory, edm::eventsetup::ModuleMaker<type>, \
                    #type);                                                                   \
