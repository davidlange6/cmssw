...
namespace edm {
  ...
  protected:
    virtual void setIntervalFor(const eventsetup::EventSetupRecordKey&, const IOVSyncValue&,
                                ValidityInterval&) = 0;
  ...
  private:
    ...
    /** override this method if you need to delay setting what records you will be using until
