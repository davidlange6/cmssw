...
/**\class EventSetupRecordProviderTemplate EventSetupRecordProviderTemplate.h
 ...
 Usage:
    NOTE: The class inherits from DependentEventSetupRecordProvider only if T inherits from
 DependentRecordTag, else the class inherits directly
  ...
  namespace eventsetup {
    ...
    std::set<EventSetupRecordKey> findDependentRecordsFor() {
      typedef typename boost::mpl::if_<
          typename std::is_base_of<edm::eventsetup::DependentRecordTag, T>::type,
