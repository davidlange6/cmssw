...
namespace edm {
  namespace eventsetup {
    ...
    class DependentRecordImplementation : public EventSetupRecordImplementation<RecordT>,
    ...
    public:
      ...
      const DepRecordT& getRecord() const {
        ...
        static_assert(!std::is_same<FoundItrT, EndItrT>::value,
                      "Trying to get a Record from another Record where the second Record is "
                      "not dependent on the first Record.");
        try {
