  ...
  namespace global {
    namespace filter {
      ...
      struct AbilityToImplementor<edm::LuminosityBlockSummaryCache<C>> {
        typedef edm::global::impl::LuminosityBlockSummaryCacheHolder<edm::global::EDFilterBase, C>
            Type;
      };
      ...
      struct SpecializeAbilityToImplementor<true, B, edm::RunSummaryCache<C>> {
        typedef typename edm::global::impl::EndRunSummaryProducer<edm::global::EDFilterBase, C>
            Type;
      };
      ...
      struct SpecializeAbilityToImplementor<B, true, edm::LuminosityBlockSummaryCache<C>> {
        typedef
            typename edm::global::impl::EndLuminosityBlockSummaryProducer<edm::global::EDFilterBase,
                                                                          C>
                Type;
      };
