  ...
  namespace global {
    namespace impl {
      ...
      private:
        ...
        virtual void doBeginStream_(StreamID id) override final { caches_[id.value()] = beginStream(id).release(); }
      ...
      private:
        void doBeginRun_(Run const& rp, EventSetup const& c) override final { cache_ = globalBeginRun(rp, c); }
