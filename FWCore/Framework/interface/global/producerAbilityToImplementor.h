  ...
  namespace global {
    namespace producer {
      ...
      struct AbilityToImplementor<edm::LuminosityBlockSummaryCache<C>> {
        typedef edm::global::impl::LuminosityBlockSummaryCacheHolder<edm::global::EDProducerBase, C>
            Type;
      };
      ...
      struct SpecializeAbilityToImplementor<true, B, edm::RunSummaryCache<C>> {
        typedef typename edm::global::impl::EndRunSummaryProducer<edm::global::EDProducerBase, C>
            Type;
      };
