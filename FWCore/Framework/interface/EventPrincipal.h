...
namespace edm {
  ...
  public:
    ...
    EventPrincipal(std::shared_ptr<ProductRegistry const> reg,
                   ...
                   unsigned int streamIndex = 0, bool isForPrimaryProcess = true);
    ...
    void fillEventPrincipal(EventAuxiliary const& aux,
                            ...
                            DelayedReader* reader = nullptr, bool deepCopyRetriever = true);
  ...
  inline bool isSameEvent(EventPrincipal const& a, EventPrincipal const& b) {
