  ...
  namespace limited {
    namespace impl {
      ...
      private:
        ...
        void doStreamBeginLuminosityBlock_(StreamID id, LuminosityBlock const& lbp,
                                           EventSetup const& c) final {
          streamBeginLuminosityBlock(id, lbp, c);
        }
        void doStreamEndLuminosityBlock_(StreamID id, LuminosityBlock const& lbp,
                                         EventSetup const& c) final {
      ...
      private:
        ...
        void doStreamEndLuminosityBlockSummary_(StreamID id, LuminosityBlock const& lb,
                                                EventSetup const& c) final {
          std::lock_guard<std::mutex> guard(mutex_);
      ...
      public:
        EndRunSummaryProducer(edm::ParameterSet const& iPSet)
            : T(iPSet), RunSummaryCacheHolder<T, C>(iPSet) {}
