...
/**\file  producerAbilityToImplementor.h
 ...
 Description: Class used to pair a module Ability to the actual base class used to implement that
 ability
  ...
  namespace limited {
    namespace producer {
      ...
      struct AbilityToImplementor<edm::LuminosityBlockCache<C>> {
        typedef edm::limited::impl::LuminosityBlockCacheHolder<edm::limited::EDProducerBase, C>
            Type;
      };

      template <typename C>
      struct AbilityToImplementor<edm::LuminosityBlockSummaryCache<C>> {
        typedef edm::limited::impl::LuminosityBlockSummaryCacheHolder<edm::limited::EDProducerBase,
                                                                      C>
            Type;
      };
      ...
      struct SpecializeAbilityToImplementor<true, B, edm::RunSummaryCache<C>> {
        typedef typename edm::limited::impl::EndRunSummaryProducer<edm::limited::EDProducerBase, C>
            Type;
      };
      ...
      struct SpecializeAbilityToImplementor<B, true, edm::LuminosityBlockSummaryCache<C>> {
        typedef typename edm::limited::impl::EndLuminosityBlockSummaryProducer<
            edm::limited::EDProducerBase, C>
            Type;
      };
