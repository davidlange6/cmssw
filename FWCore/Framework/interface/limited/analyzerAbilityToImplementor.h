...
//
/**\file  analyzerAbilityToImplementor.h
 "FWCore/Framework/interface/limited/analyzerAbilityToImplementor.h"
  ...
  namespace limited {
    namespace analyzer {
      ...
      struct AbilityToImplementor<edm::LuminosityBlockCache<C>> {
        typedef edm::limited::impl::LuminosityBlockCacheHolder<edm::limited::EDAnalyzerBase, C>
            Type;
      };

      template <typename C>
      struct AbilityToImplementor<edm::LuminosityBlockSummaryCache<C>> {
        typedef edm::limited::impl::LuminosityBlockSummaryCacheHolder<edm::limited::EDAnalyzerBase,
                                                                      C>
            Type;
      };
    }
