...
/**\file  filterAbilityToImplementor.h
 "FWCore/Framework/interface/limited/filterAbilityToImplementor.h"
  ...
  namespace limited {
    namespace filter {
      ...
      struct AbilityToImplementor<edm::LuminosityBlockSummaryCache<C>> {
        typedef edm::limited::impl::LuminosityBlockSummaryCacheHolder<edm::limited::EDFilterBase, C>
            Type;
      };
      ...
      struct SpecializeAbilityToImplementor<true, B, edm::RunSummaryCache<C>> {
        typedef typename edm::limited::impl::EndRunSummaryProducer<edm::limited::EDFilterBase, C>
            Type;
      };
