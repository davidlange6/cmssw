...
/**\struct edm::eventsetup::ComponentDescription
 ...
 Description: minimal set of information to describe an EventSetup component (ESSource or
 ESProducer)
...
namespace edm {
  namespace eventsetup {
    struct ComponentDescription {
      ...
      ComponentDescription(std::string const& iType, std::string const& iLabel, bool iIsSource,
