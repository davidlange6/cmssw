  ...
  namespace eventsetup {
    ...
    public:
      ...
      CallbackProxy(std::shared_ptr<CallbackT>& iCallback) : data_(), callback_(iCallback) {
        // The callback fills the data directly.  This is done so that the callback does not
        // have to
        //  hold onto a temporary copy of the result of the callback since the callback is
        //  allowed
