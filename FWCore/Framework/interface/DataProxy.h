  ...
  namespace eventsetup {
    ...
    protected:
      /**This is the function which does the real work of getting the data if it is not
       ...
       type corresponding to the type designated in iKey. So if iKey refers to a base class
       interface
       the pointer must be a pointer to that base class interface and not a pointer to an
       inheriting class
       instance.
       */
