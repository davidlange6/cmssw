...
namespace edmtest {
  namespace global {
    ...
    class RunIntFilter
        : public edm::global::EDFilter<edm::StreamCache<UnsafeCache>, edm::RunCache<Cache>> {
    public:
    ...
    class LumiIntFilter : public edm::global::EDFilter<edm::StreamCache<UnsafeCache>,
    ...
    class TestBeginRunFilter
        : public edm::global::EDFilter<edm::RunCache<Dummy>, edm::BeginRunProducer> {
    public:
    ...
    class TestEndLumiBlockFilter : public edm::global::EDFilter<edm::LuminosityBlockCache<Dummy>,
