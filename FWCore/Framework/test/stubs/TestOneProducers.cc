  ...
  namespace one {
    ...
    public:
      ...
      ~SharedResourcesProducer() noexcept(false) {
        if (m_count != trans_) {
          throw cms::Exception("transitions") << "SharedResourcesProducer transitions " << m_count
    ...
    public:
      ...
      ~WatchRunsProducer() noexcept(false) {
        if (m_count != trans_) {
          throw cms::Exception("transitions") << "WatchRunsProducer transitions " << m_count
                                              << " but it was supposed to be " << trans_;
        }
      }
    };
    ...
    public:
      ...
      ~WatchLumiBlocksProducer() noexcept(false) {
        if (m_count != trans_) {
          throw cms::Exception("transitions") << "WatchLumiBlockProducer transitions " << m_count
                                              << " but it was supposed to be " << trans_;
        }
      }
    };
    ...
    class TestEndLumiBlockProducer : public edm::one::EDProducer<edm::one::WatchLuminosityBlocks,
