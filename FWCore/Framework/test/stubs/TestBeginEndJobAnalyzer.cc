...
void TestBeginEndJobAnalyzer::beginRun(edm::Run const&, edm::EventSetup const&) {
  control().beginRunCalled = true;
}

void TestBeginEndJobAnalyzer::endRun(edm::Run const&, edm::EventSetup const&) {
  control().endRunCalled = true;
}

void TestBeginEndJobAnalyzer::beginLuminosityBlock(edm::LuminosityBlock const&,
                                                   edm::EventSetup const&) {
  control().beginLumiCalled = true;
}

void TestBeginEndJobAnalyzer::endLuminosityBlock(edm::LuminosityBlock const&,
                                                 edm::EventSetup const&) {
  control().endLumiCalled = true;
}

void TestBeginEndJobAnalyzer::analyze(const edm::Event& /* iEvent */,
