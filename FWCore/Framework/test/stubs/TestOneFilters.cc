  ...
  namespace one {
    ...
    public:
      ...
      ~SharedResourcesFilter() {
        if (m_count != trans_) {
          throw cms::Exception("transitions") << "SharedResourcesFilter transitions " << m_count
    ...
    public:
      ...
      ~WatchRunsFilter() {
        if (m_count != trans_) {
          throw cms::Exception("transitions") << "WatchRunsFilter transitions " << m_count
                                              << " but it was supposed to be " << trans_;
        }
      }
    };
    ...
    public:
      ...
      ~WatchLumiBlocksFilter() {
        if (m_count != trans_) {
          throw cms::Exception("transitions") << "WatchLumiBlocksFilter transitions " << m_count
                                              << " but it was supposed to be " << trans_;
        }
      }
    };
    ...
    public:
      ...
      ~BeginRunFilter() {
        if (m_count != trans_) {
          throw cms::Exception("transitions") << "BeginRunFilter transitions " << m_count
                                              << " but it was supposed to be " << trans_;
        }
      }
    };

    class BeginLumiBlockFilter : public edm::one::EDFilter<edm::one::WatchLuminosityBlocks,
    ...
    public:
      ...
      ~BeginLumiBlockFilter() {
        if (m_count != trans_) {
          throw cms::Exception("transitions") << "BeginLumiBlockFilter transitions " << m_count
                                              << " but it was supposed to be " << trans_;
        }
      }
    };
    ...
    class EndLumiBlockFilter : public edm::one::EDFilter<edm::one::WatchLuminosityBlocks,
    ...
    public:
      ...
      ~EndLumiBlockFilter() {
        if (m_count != trans_) {
          throw cms::Exception("transitions") << "EndLumiBlockFilter transitions " << m_count
                                              << " but it was supposed to be " << trans_;
        }
      }
    };
