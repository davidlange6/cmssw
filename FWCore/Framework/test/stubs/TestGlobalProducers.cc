...
namespace edmtest {
  namespace global {
    ...
    class RunIntProducer
        : public edm::global::EDProducer<edm::StreamCache<UnsafeCache>, edm::RunCache<Cache>> {
    public:
    ...
    class LumiIntProducer : public edm::global::EDProducer<edm::StreamCache<UnsafeCache>,
    ...
    class TestBeginRunProducer
        : public edm::global::EDProducer<edm::RunCache<Dummy>, edm::BeginRunProducer> {
    public:
    ...
    class TestEndRunProducer
        : public edm::global::EDProducer<edm::RunCache<Dummy>, edm::EndRunProducer> {
    public:
