...
void testdependentrecord::dependentFinder1Test() {
  ...
  CPPUNIT_ASSERT(definedInterval ==
                 finder.findIntervalFor(depRecordKey, edm::IOVSyncValue(edm::EventID(1, 1, 2))));
...
void testdependentrecord::timeAndRunTest() {
  ...
  CPPUNIT_ASSERT(overlapInterval ==
                 finder.findIntervalFor(
                     depRecordKey, edm::IOVSyncValue(edm::EventID(1, 1, 4), edm::Timestamp(3))));

  // should give back same interval
  CPPUNIT_ASSERT(overlapInterval ==
                 finder.findIntervalFor(
                     depRecordKey, edm::IOVSyncValue(edm::EventID(1, 1, 4), edm::Timestamp(4))));

  // should give back same interval
  CPPUNIT_ASSERT(overlapInterval ==
                 finder.findIntervalFor(
                     depRecordKey, edm::IOVSyncValue(edm::EventID(1, 1, 2), edm::Timestamp(3))));

  // should give back same interval
  CPPUNIT_ASSERT(overlapInterval ==
                 finder.findIntervalFor(
                     depRecordKey, edm::IOVSyncValue(edm::EventID(1, 1, 1), edm::Timestamp(2))));
  ...
  CPPUNIT_ASSERT(overlapInterval2 ==
                 finder.findIntervalFor(
                     depRecordKey, edm::IOVSyncValue(edm::EventID(1, 1, 6), edm::Timestamp(5))));
  ...
  CPPUNIT_ASSERT(overlapInterval3 ==
                 finder.findIntervalFor(
                     depRecordKey, edm::IOVSyncValue(edm::EventID(1, 1, 7), edm::Timestamp(7))));
  ...
  // Change both but make run/lumi/event 'closer'
  {
    ...
    CPPUNIT_ASSERT(
        overlapInterval ==
        finder.findIntervalFor(
            depRecordKey, edm::IOVSyncValue(edm::EventID(1, 12, 50), edm::Timestamp(70ULL << 32))));
  }
  ...
  CPPUNIT_ASSERT(overlapInterval3 ==
                 finder.findIntervalFor(
                     depRecordKey, edm::IOVSyncValue(edm::EventID(1, 1, 11), edm::Timestamp(8))));
  ...
  CPPUNIT_ASSERT(overlapInterval4 ==
                 finder.findIntervalFor(
                     depRecordKey, edm::IOVSyncValue(edm::EventID(1, 1, 13), edm::Timestamp(11))));

  {
    ...
    CPPUNIT_ASSERT(overlapInterval ==
                   finder.findIntervalFor(
                       depRecordKey, edm::IOVSyncValue(edm::EventID(1, 1, 4), edm::Timestamp(1))));
    ...
    CPPUNIT_ASSERT(overlapInterval2 ==
                   finder.findIntervalFor(
                       depRecordKey, edm::IOVSyncValue(edm::EventID(1, 1, 5), edm::Timestamp(3))));
  }
  {
    // check for bug which only happens the first time we synchronize
    ...
    CPPUNIT_ASSERT(overlapInterval2 ==
                   finder.findIntervalFor(
                       depRecordKey, edm::IOVSyncValue(edm::EventID(1, 1, 5), edm::Timestamp(4))));
  }
...
void testdependentrecord::getTest() {
  ...
  provider.add(depProv);
  {
    const edm::EventSetup& eventSetup =
        provider.eventSetupForInstance(edm::IOVSyncValue(edm::EventID(1, 1, 1)));
  ...
  {
    const edm::EventSetup& eventSetup =
        provider.eventSetupForInstance(edm::IOVSyncValue(edm::EventID(1, 1, 4)));
...
void testdependentrecord::alternateFinderTest() {
  ...
  CPPUNIT_ASSERT(depInterval ==
                 finder.findIntervalFor(depRecordKey, edm::IOVSyncValue(edm::EventID(1, 1, 1))));
...
void testdependentrecord::invalidRecordTest() {
  ...
  CPPUNIT_ASSERT(openEnded2 ==
                 finder.findIntervalFor(depRecordKey, edm::IOVSyncValue(edm::EventID(1, 1, 7))));
}
...
void testdependentrecord::extendIOVTest() {
  ...
  dummyFinder->setInterval(
      edm::ValidityInterval{startSyncValue, edm::IOVSyncValue{edm::EventID{1, 1, 5}}});
  provider.add(std::shared_ptr<edm::EventSetupRecordIntervalFinder>{dummyFinder});
  ...
  dummy2Finder->setInterval(
      edm::ValidityInterval{startSyncValue, edm::IOVSyncValue{edm::EventID{1, 1, 6}}});
  provider.add(std::shared_ptr<edm::EventSetupRecordIntervalFinder>(dummy2Finder));
  {
    ...
    dummyFinder->setInterval(
        edm::ValidityInterval{startSyncValue, edm::IOVSyncValue{edm::EventID{1, 1, 7}}});
    {
      const edm::EventSetup& eventSetup = provider.eventSetupForInstance(
    ...
    dummy2Finder->setInterval(
        edm::ValidityInterval{startSyncValue, edm::IOVSyncValue{edm::EventID{1, 1, 8}}});
    ...
    dummy2Finder->setInterval(
        edm::ValidityInterval{startSyncValue, edm::IOVSyncValue{edm::EventID{1, 1, 9}}});
