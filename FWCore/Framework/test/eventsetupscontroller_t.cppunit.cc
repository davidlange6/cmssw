...
void TestEventSetupsController::esProducerGetAndPutTest() {
  ...
  std::multimap<edm::ParameterSetID, edm::eventsetup::ESProducerInfo> const& esproducers =
      esController.esproducers();
  ...
  CPPUNIT_ASSERT_THROW(esController.lookForMatches(pset4.id(), 6, 0, firstProcessWithThisPSet,
...
void TestEventSetupsController::esSourceGetAndPutTest() {
  ...
  std::multimap<edm::ParameterSetID, edm::eventsetup::ESSourceInfo> const& essources =
      esController.essources();
  bool isPresent1 = false;
  bool isPresent2 = false;
  bool isPresent3 = false;
  bool isPresent4 = false;
