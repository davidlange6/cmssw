...
private:
  ...
  public:
    ...
    const DummyData* produce(const DummyRecord& /*iRecord*/) { return &data_; }
  ...
  public:
    enum { kFi, kFum };
    typedef edm::ESProducts<edm::es::L<DummyData, kFi>, edm::es::L<DummyData, kFum> >
        ReturnProducts;
...
public:
  DepProducer() : ptr_(new DummyData) {
    ptr_->value_ = 0;
    setWhatProduced(
        this, dependsOn(&DepProducer::callWhenDummyChanges, &DepProducer::callWhenDummyChanges2,
