...
namespace edm {
  ...
  namespace {
    ...
    inline bool partial_match(const std::regex& regularExpression,
  ...
  ProductSelectorRules::Rule::Rule(std::string const& s, std::string const& parameterName,
  ...
  void ProductSelectorRules::Rule::applyToOne(edm::BranchDescription const* branch,
                                              bool& result) const {
