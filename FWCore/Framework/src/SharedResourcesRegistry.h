...
/**\class SharedResourcesRegistry SharedResourcesRegistry.h "SharedResourcesRegistry.h"
 ...
 Description: Manages the Acquirers used to take temporary control of a resource shared between
 modules
...
namespace edm {
  ...
  public:
    ...
    std::map<std::string, std::pair<std::shared_ptr<SerialTaskQueue>, unsigned int>> const&
    resourceMap() const {
      return resourceMap_;
    }
#endif
