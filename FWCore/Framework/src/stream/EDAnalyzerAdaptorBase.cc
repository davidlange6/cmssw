...
std::vector<edm::ProductResolverIndexAndSkipBit> const& EDAnalyzerAdaptorBase::itemsToGetFrom(
...
bool EDAnalyzerAdaptorBase::doEvent(EventPrincipal const& ep, EventSetup const& c,
...
void EDAnalyzerAdaptorBase::doStreamBeginRun(StreamID id, RunPrincipal const& rp,
