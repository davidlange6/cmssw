...
// member functions
//
void ESProducerLooper::setIntervalFor(const EventSetupRecordKey&, const IOVSyncValue&,
...
void ESProducerLooper::registerFactoryWithKey(
    ...
    std::unique_ptr<eventsetup::ProxyFactoryBase> iFactory, const std::string& iLabel) {
...
//
std::set<eventsetup::EventSetupRecordKey> ESProducerLooper::modifyingRecords() const {
