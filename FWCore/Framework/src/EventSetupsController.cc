...
namespace edm {
  namespace eventsetup {
    ...
    void EventSetupsController::lookForMatches(ParameterSetID const& psetID, unsigned subProcessIndex,
                                               unsigned precedingProcessIndex, bool& firstProcessWithThisPSet,
    ...
    bool EventSetupsController::isMatchingESSource(ParameterSetID const& psetID, unsigned subProcessIndex,
                                                   unsigned precedingProcessIndex) const {
    ...
    bool EventSetupsController::isMatchingESProducer(ParameterSetID const& psetID, unsigned subProcessIndex,
                                                     unsigned precedingProcessIndex) const {
      auto elements = esproducers_.equal_range(psetID);
      for (auto it = elements.first; it != elements.second; ++it) {
        std::vector<unsigned> const& subProcessIndexes = it->second.subProcessIndexes();
