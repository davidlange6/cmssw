...
namespace edm {
  namespace eventsetup {
    ...
    static void preferEverything(const ComponentDescription& iComponent, const Providers& iProviders,
    ...
    static void findDependents(const EventSetupRecordKey& iKey, Itr itBegin, Itr itEnd,
