...
namespace edm {
  namespace eventsetup {
    ...
    //
    // const EventSetupRecordProviderFactoryManager& EventSetupRecordProviderFactoryManager::operator=(const
    // EventSetupRecordProviderFactoryManager& rhs)
    // {
    ...
    //
    std::unique_ptr<EventSetupRecordProvider> EventSetupRecordProviderFactoryManager::makeRecordProvider(
        const EventSetupRecordKey& iKey) const {
      std::map<EventSetupRecordKey, const EventSetupRecordProviderFactory*>::const_iterator itFound =
