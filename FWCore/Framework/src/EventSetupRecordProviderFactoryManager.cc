...
namespace edm {
  namespace eventsetup {
    ...
    void EventSetupRecordProviderFactoryManager::addFactory(
        const EventSetupRecordProviderFactory& iFactory, const EventSetupRecordKey& iKey) {
    ...
    EventSetupRecordProviderFactoryManager::makeRecordProvider(
      ...
      std::map<EventSetupRecordKey, const EventSetupRecordProviderFactory*>::const_iterator
          itFound = factories_.find(iKey);
