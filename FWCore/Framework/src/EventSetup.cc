...
namespace edm {
  ...
  const eventsetup::EventSetupRecord* EventSetup::find(
    ...
    std::map<eventsetup::EventSetupRecordKey, eventsetup::EventSetupRecord const*>::const_iterator
        itFind = recordMap_.find(iKey);
  ...
  void EventSetup::fillAvailableRecordKeys(
    ...
    typedef std::map<eventsetup::EventSetupRecordKey, eventsetup::EventSetupRecord const*>
        KeyToRecordMap;
