...
namespace edm {
  ...
  public:
    ...
    template <typename T>
    void runAllModulesAsync(WaitingTask*, typename T::MyPrincipal const&, EventSetup const&,
  ...
  private:
    ...
    bool handleWorkerFailure(cms::Exception& e, int nwrwue, bool isEvent, bool begin,
    ...
    void workerFinished(std::exception_ptr const* iException, unsigned int iModuleIndex,
                        EventPrincipal const& iEP, EventSetup const& iES, StreamID const& iID,
                        StreamContext const* iContext);
    void runNextWorkerAsync(unsigned int iNextModuleIndex, EventPrincipal const&, EventSetup const&,
                            StreamID const&, StreamContext const*);
  };
  ...
  template <typename T>
  void Path::runAllModulesAsync(WaitingTask* task, typename T::MyPrincipal const& p,
