...
namespace edm {
  ...
  private:
    ...
    bool implDoPrePrefetchSelection(StreamID id, EventPrincipal const& ep,
                                    ModuleCallingContext const* mcc) override;
    ...
    void implRegisterThinnedAssociations(ProductRegistry const&,
                                         ThinnedAssociationsHelper&) override;
    ...
    void modulesWhoseProductsAreConsumed(
      ...
      module_->modulesWhoseProductsAreConsumed(modules, preg, labelsToDesc,
