...
namespace edm {
  std::vector<std::string> defaultCmsRunServices() {
    std::vector<std::string> returnValue = {
        "MessageLogger",          "InitRootHandlers",
        "UnixSignalService",      "AdaptorConfig",
        "SiteLocalConfigService", "StatisticsSenderService",
        "CondorStatusService",    "XrdAdaptor::XrdStatisticsService"};
