...
namespace edm {
  ...
  std::unique_ptr<WrapperBase> DelayedReader::getProduct(BranchKey const& k,
  ...
  std::pair<SharedResourcesAcquirer*, std::recursive_mutex*> DelayedReader::sharedResources_()
      const {
