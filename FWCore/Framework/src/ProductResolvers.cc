...
namespace edm {
  ...
  void DataManagingProductResolver::throwProductDeletedException() const {
    ...
    exception << "ProductResolverBase::resolveProduct_: The product matching all criteria was "
                 "already deleted\n"
              ...
              << "The module which is asking for this data must be configured to state that it "
                 "will read this data.";
    throw exception;
  }
  ...
  ProductResolverBase::Resolution DataManagingProductResolver::resolveProductImpl(
    ...
    if (callResolver && presentStatus == ProductStatus::ResolveNotRun) {
      ...
      std::unique_ptr<ProductStatus, decltype(failedStatusSetter)> failedStatusGuard(
          &presentStatus, failedStatusSetter);
  ...
  void InputProductResolver::prefetchAsync_(WaitingTask* waitTask, Principal const& principal,
      ...
      return resolveProductImpl<true>([&principal, this, sra, mcc]() {
        try {
          ...
          ost << "Calling produce method for unscheduled module "
              << worker_->description().moduleName() << "/'" << worker_->description().moduleLabel()
              << "'";
  ...
  void ProducedProductResolver::putProduct_(std::unique_ptr<WrapperBase> edp) const {
    if (status() != defaultStatus()) {
      throw Exception(errors::InsertFailure) << "Attempt to insert more than one product on branch "
  ...
  void DataManagingProductResolver::connectTo(ProductResolverBase const& iOther, Principal const*) {
    assert(false);
  }
  ...
  void AliasProductResolver::putOrMergeProduct_(std::unique_ptr<WrapperBase> edp) const {
    throw Exception(errors::LogicError)
        << "AliasProductResolver::putOrMergeProduct_(std::unique_ptr<WrapperBase> edp) not "
  ...
  void ParentProcessProductResolver::putProduct_(std::unique_ptr<WrapperBase>) const {
    throw Exception(errors::LogicError) << "ParentProcessProductResolver::putProduct_() not "
                                           "implemented and should never be called.\n"
                                        << "Contact a Framework developer\n";
  }
  ...
  void ParentProcessProductResolver::throwNullRealProduct() const {
    ...
    throw Exception(errors::LogicError) << "ParentProcessProductResolver::throwNullRealProduct "
                                           "RealProduct pointer not set in this context.\n"
                                        << "Contact a Framework developer\n";
  }

  NoProcessProductResolver::NoProcessProductResolver(
      std::vector<ProductResolverIndex> const& matchingHolders, std::vector<bool> const& ambiguous)
  ...
  ProductResolverBase::Resolution NoProcessProductResolver::resolveProduct_(
    ...
    const unsigned int choiceSize = ambiguous_.size();
    {
      if ((not principal.atEndTransition()) or recheckedAtEnd_) {
        unsigned int checkCacheIndex =
            skipCurrentProcess ? lastSkipCurrentCheckIndex_.load() : lastCheckIndex_.load();
  ...
  namespace {
    ...
    public:
      TryNextResolverWaitingTask(NoProcessProductResolver const* iResolver,
                                 unsigned int iResolverIndex, Principal const* iPrincipal,
                                 SharedResourcesAcquirer* iSRA, ModuleCallingContext const* iMCC,
      ...
      tbb::task* execute() override {
        ...
        if (exceptPtr) {
          ...
          if (not resolver_->dataValidFromResolver(index_, *principal_, skipCurrentProcess_)) {
            resolver_->tryPrefetchResolverAsync(index_ + 1, *principal_, skipCurrentProcess_, sra_,
                                                mcc_, serviceToken_);
          }
        }
        return nullptr;
  ...
  void NoProcessProductResolver::tryPrefetchResolverAsync(
      unsigned int iProcessingIndex, Principal const& principal, bool skipCurrentProcess,
      SharedResourcesAcquirer* sra, ModuleCallingContext const* mcc, ServiceToken token) const {
    std::vector<unsigned int> const& lookupProcessOrder = principal.lookupProcessOrder();
  ...
  void NoProcessProductResolver::setProvenance_(ProductProvenanceRetriever const*,
                                                ProcessHistory const&, ProductID const&) {}
  ...
  bool NoProcessProductResolver::unscheduledWasNotRun_() const {
    throw Exception(errors::LogicError) << "NoProcessProductResolver::unscheduledWasNotRun_() "
                                           "not implemented and should never be called.\n"
                                        << "Contact a Framework developer\n";
  }

  bool NoProcessProductResolver::productUnavailable_() const {
    throw Exception(errors::LogicError) << "NoProcessProductResolver::productUnavailable_() not "
                                           "implemented and should never be called.\n"
                                        << "Contact a Framework developer\n";
  }

  bool NoProcessProductResolver::productResolved_() const {
    throw Exception(errors::LogicError) << "NoProcessProductResolver::productResolved_() not "
                                           "implemented and should never be called.\n"
                                        << "Contact a Framework developer\n";
  }

  bool NoProcessProductResolver::productWasDeleted_() const {
    throw Exception(errors::LogicError) << "NoProcessProductResolver::productWasDeleted_() not "
                                           "implemented and should never be called.\n"
                                        << "Contact a Framework developer\n";
  }
  ...
  bool NoProcessProductResolver::productWasFetchedAndIsValid_(bool /*iSkipCurrentProcess*/) const {
    throw Exception(errors::LogicError)
        << "NoProcessProductResolver::productWasFetchedAndIsValid_() not implemented and should "
           "never be called.\n"
        << "Contact a Framework developer\n";
  }
  ...
  void NoProcessProductResolver::putOrMergeProduct_(std::unique_ptr<WrapperBase> edp) const {
    throw Exception(errors::LogicError)
        << "NoProcessProductResolver::putOrMergeProduct_(std::unique_ptr<WrapperBase> edp) not "
           "implemented and should never be called.\n"
        << "Contact a Framework developer\n";
  }

  BranchDescription const& NoProcessProductResolver::branchDescription_() const {
    throw Exception(errors::LogicError) << "NoProcessProductResolver::branchDescription_() not "
                                           "implemented and should never be called.\n"
                                        << "Contact a Framework developer\n";
  }

  void NoProcessProductResolver::resetBranchDescription_(std::shared_ptr<BranchDescription const>) {
    throw Exception(errors::LogicError) << "NoProcessProductResolver::resetBranchDescription_() "
                                           "not implemented and should never be called.\n"
                                        << "Contact a Framework developer\n";
  }
  ...
  bool SingleChoiceNoProcessProductResolver::unscheduledWasNotRun_() const {
    throw Exception(errors::LogicError)
        << "SingleChoiceNoProcessProductResolver::unscheduledWasNotRun_() not implemented and "
  ...
  bool SingleChoiceNoProcessProductResolver::productUnavailable_() const {
    throw Exception(errors::LogicError)
        << "SingleChoiceNoProcessProductResolver::productUnavailable_() not implemented and "
           "should never be called.\n"
        << "Contact a Framework developer\n";
  }
  ...
  bool SingleChoiceNoProcessProductResolver::productResolved_() const {
    throw Exception(errors::LogicError)
        << "SingleChoiceNoProcessProductResolver::productResolved_() not implemented and should "
           "never be called.\n"
        << "Contact a Framework developer\n";
  }
  ...
  bool SingleChoiceNoProcessProductResolver::productWasDeleted_() const {
    throw Exception(errors::LogicError)
        << "SingleChoiceNoProcessProductResolver::productWasDeleted_() not implemented and "
           "should never be called.\n"
        << "Contact a Framework developer\n";
  }
  ...
  bool SingleChoiceNoProcessProductResolver::productWasFetchedAndIsValid_(
      bool /*iSkipCurrentProcess*/) const {
    throw Exception(errors::LogicError)
        << "SingleChoiceNoProcessProductResolver::productWasFetchedAndIsValid_() not implemented "
           "and should never be called.\n"
        << "Contact a Framework developer\n";
  }

  void SingleChoiceNoProcessProductResolver::putProduct_(std::unique_ptr<WrapperBase>) const {
    throw Exception(errors::LogicError) << "SingleChoiceNoProcessProductResolver::putProduct_() "
                                           "not implemented and should never be called.\n"
                                        << "Contact a Framework developer\n";
  }
  ...
  void SingleChoiceNoProcessProductResolver::putOrMergeProduct_(
    ...
    throw Exception(errors::LogicError)
        << "SingleChoiceNoProcessProductResolver::putOrMergeProduct_(std::unique_ptr<WrapperBase>"
  ...
  BranchDescription const& SingleChoiceNoProcessProductResolver::branchDescription_() const {
    throw Exception(errors::LogicError)
        << "SingleChoiceNoProcessProductResolver::branchDescription_() not implemented and "
           "should never be called.\n"
        << "Contact a Framework developer\n";
  }
  ...
  void SingleChoiceNoProcessProductResolver::resetBranchDescription_(
    ...
    throw Exception(errors::LogicError)
        << "SingleChoiceNoProcessProductResolver::resetBranchDescription_() not implemented and "
           "should never be called.\n"
        << "Contact a Framework developer\n";
  }

  Provenance const* SingleChoiceNoProcessProductResolver::provenance_() const {
    throw Exception(errors::LogicError) << "SingleChoiceNoProcessProductResolver::provenance_() "
                                           "not implemented and should never be called.\n"
                                        << "Contact a Framework developer\n";
  }
  ...
  void SingleChoiceNoProcessProductResolver::connectTo(ProductResolverBase const&,
                                                       Principal const*) {
    throw Exception(errors::LogicError) << "SingleChoiceNoProcessProductResolver::connectTo() "
                                           "not implemented and should never be called.\n"
                                        << "Contact a Framework developer\n";
  }
}
