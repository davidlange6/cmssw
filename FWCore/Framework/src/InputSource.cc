...
namespace edm {
  ...
  InputSource::InputSource(ParameterSet const& pset, InputSourceDescription const& desc)
    ...
    // The default value provided as the second argument to the getUntrackedParameter function
    // call
    // is not used when the ParameterSet has been validated and the parameters are not optional
    // in the description.  As soon as all primary input sources and all modules with a secondary
    // input sources have defined descriptions, the defaults in the getUntrackedParameterSet
    // function
  ...
  std::shared_ptr<LuminosityBlockAuxiliary> InputSource::readLuminosityBlockAuxiliary() {
    return callWithTryCatchAndPrint<std::shared_ptr<LuminosityBlockAuxiliary> >(
        [this]() { return readLuminosityBlockAuxiliary_(); },
        "Calling InputSource::readLuminosityBlockAuxiliary_");
  }

  std::shared_ptr<RunAuxiliary> InputSource::readRunAuxiliary() {
    return callWithTryCatchAndPrint<std::shared_ptr<RunAuxiliary> >(
        [this]() { return readRunAuxiliary_(); }, "Calling InputSource::readRunAuxiliary_");
  }
  ...
  void InputSource::registerProducts() {
    if (!typeLabelList().empty()) {
      addToRegistry(typeLabelList().begin(), typeLabelList().end(), moduleDescription(),
  ...
  void InputSource::readAndMergeRun(RunPrincipal& rp) {
    RunSourceSentry sentry(*this);
    callWithTryCatchAndPrint<void>([this, &rp]() { readRun_(rp); },
                                   "Calling InputSource::readRun_");
  }
  ...
  void InputSource::readLuminosityBlock(LuminosityBlockPrincipal& lumiPrincipal, HistoryAppender&) {
    ...
    callWithTryCatchAndPrint<void>(
        [this, &lumiPrincipal]() { readLuminosityBlock_(lumiPrincipal); },
  ...
  void InputSource::readEvent(EventPrincipal& ep, StreamContext& streamContext) {
    ...
    {
      // block scope, in order to issue the PostSourceEvent signal before calling postRead and
      // issueReports
      EventSourceSentry sentry(*this, streamContext);

      callWithTryCatchAndPrint<void>([this, &ep]() { readEvent_(ep); },
  ...
  bool InputSource::readEvent(EventPrincipal& ep, EventID const& eventID,
    ...
    if (not limitReached()) {
      ...
      // result = callWithTryCatchAndPrint<bool>( [this,&eventID,&ep](){ return readIt(eventID,
      // ep); }, "Calling InputSource::readIt" );
  ...
  void InputSource::skipEvents(int offset) {
    callWithTryCatchAndPrint<void>([this, &offset]() { skip(offset); },
  ...
  void InputSource::issueReports(EventID const& eventID) {
    if (isInfoEnabled()) {
      LogVerbatim("FwkReport") << "Begin processing the " << readCount_ << suffix(readCount_)
                               << " record. Run " << eventID.run() << ", Event " << eventID.event()
                               << ", LumiSection " << eventID.luminosityBlock() << " at "
  ...
  void InputSource::doBeginRun(RunPrincipal& rp, ProcessContext const*) {
    ...
    callWithTryCatchAndPrint<void>([this, &run]() { beginRun(run); },
                                   "Calling InputSource::beginRun");
    run.commit_(std::vector<edm::ProductResolverIndex>());
  }

  void InputSource::doEndRun(RunPrincipal& rp, bool cleaningUpAfterException,
                             ProcessContext const*) {
    Run run(rp, moduleDescription(), nullptr);
    callWithTryCatchAndPrint<void>([this, &run]() { endRun(run); }, "Calling InputSource::endRun",
                                   cleaningUpAfterException);
    run.commit_(std::vector<edm::ProductResolverIndex>());
  }
  ...
  void InputSource::doBeginLumi(LuminosityBlockPrincipal& lbp, ProcessContext const*) {
    ...
    callWithTryCatchAndPrint<void>([this, &lb]() { beginLuminosityBlock(lb); },
                                   "Calling InputSource::beginLuminosityBlock");
    lb.commit_(std::vector<edm::ProductResolverIndex>());
  }

  void InputSource::doEndLumi(LuminosityBlockPrincipal& lbp, bool cleaningUpAfterException,
                              ProcessContext const*) {
    LuminosityBlock lb(lbp, moduleDescription(), nullptr);
    callWithTryCatchAndPrint<void>([this, &lb]() { endLuminosityBlock(lb); },
                                   "Calling InputSource::endLuminosityBlock",
                                   cleaningUpAfterException);
    lb.commit_(std::vector<edm::ProductResolverIndex>());
  }
  ...
  ProcessingController::ForwardState InputSource::forwardState() const {
    return callWithTryCatchAndPrint<ProcessingController::ForwardState>(
        [this]() { return forwardState_(); }, "Calling InputSource::forwardState_");
  }

  ProcessingController::ReverseState InputSource::reverseState() const {
    return callWithTryCatchAndPrint<ProcessingController::ReverseState>(
        [this]() { return reverseState_(); }, "Calling InputSource::reverseState__");
  }
  ...
  InputSource::SourceSentry::SourceSentry(Sig& pre, Sig& post) : post_(post) { pre(); }

  InputSource::SourceSentry::~SourceSentry() { post_(); }
