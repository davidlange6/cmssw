...
//
/**\class edm::PreallocationConfiguration PreallocationConfiguration.h
...
namespace edm {
  ...
  public:
    ...
    PreallocationConfiguration(unsigned int iNThreads, unsigned int iNStreams, unsigned int iNLumis,
                               unsigned int iNRuns)
  ...
  private:
    ...
    // const PreallocationConfiguration& operator=(const PreallocationConfiguration&) = delete; //
    // stop default
