...
namespace edm {
  namespace one {
    namespace impl {
      ...
      template <typename T>
      void LuminosityBlockWatcher<T>::doBeginLuminosityBlock_(LuminosityBlock const& rp,
                                                              EventSetup const& c) {
      ...
      template <typename T>
      void BeginLuminosityBlockProducer<T>::doBeginLuminosityBlockProduce_(LuminosityBlock& rp,
                                                                           EventSetup const& c) {
        this->beginLuminosityBlockProduce(rp, c);
      }

      template <typename T>
      void EndLuminosityBlockProducer<T>::doEndLuminosityBlockProduce_(LuminosityBlock& rp,
                                                                       EventSetup const& c) {
