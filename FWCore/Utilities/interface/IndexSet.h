...
namespace edm {
  ...
  private:
    std::vector<bool> content_;  /// Each possible element of the set corresponds an index in this
                                 /// vector. The value of an element tells if that index exists in
                                 /// the set (true) or not (false).
