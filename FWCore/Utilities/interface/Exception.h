...
namespace cms {
  ...
  public:
    ...
    friend typename detail::Desired<E, detail::is_derived_or_same<Exception, E>::value>::type&
    operator<<(E& e, T const& stuff);

    template <typename E, typename T>
    friend typename detail::Desired<E, detail::is_derived_or_same<Exception, E>::value>::type const&
  ...
  template <typename E, typename T>
  inline typename detail::Desired<E, detail::is_derived_or_same<Exception, E>::value>::type&
  operator<<(E& e, T const& stuff) {
    e.ost_ << stuff;
    return e;
  }
  ...
  template <typename E, typename T>
  inline typename detail::Desired<E, detail::is_derived_or_same<Exception, E>::value>::type const&
  operator<<(E const& e, T const& stuff) {
