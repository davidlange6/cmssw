...
namespace edm {
  enum class Transition { Event, BeginLuminosityBlock, EndLuminosityBlock, BeginRun, EndRun };
  ...
  constexpr Transition convertToTransition(BranchType iValue) {
    constexpr Transition trans[] = {Transition::Event, Transition::BeginLuminosityBlock,
                                    Transition::BeginRun};
    return trans[iValue];
  }
