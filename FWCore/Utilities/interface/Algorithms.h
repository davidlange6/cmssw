...
namespace edm {
  ...
  inline typename ForwardSequence::const_iterator find_in_all(ForwardSequence const& s,
                                                              Datum const& d) {
  ...
  inline typename ForwardSequence::const_iterator find_if_in_all(ForwardSequence const& s,
                                                                 Predicate const& p) {
