...
namespace edm {
  ...
  std::string FunctionWithDict::typeName() const {
  ...
  void FunctionWithDict::invoke(ObjectWithDict const& obj, ObjectWithDict* ret /*=nullptr*/,
