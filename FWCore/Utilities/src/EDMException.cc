...
namespace edm {
  ...
  void Exception::throwThis(errors::ErrorCodes aCategory, char const* message0,
                            char const* message1, char const* message2, char const* message3,
                            char const* message4) {
  ...
  void Exception::throwThis(errors::ErrorCodes aCategory, char const* message0, int intVal,
                            char const* message1) {
    Exception e(aCategory, std::string(message0));
    e << intVal << message1;
    throw e;
