...
namespace {
  ...
  public:
    ...
    // ---------- member functions ---------------------------
    virtual void runCommand(edm::MessageLoggerQ::OpCode opcode, void *operand) override;
...
void MessageLoggerQ::MLqEND() { simpleCommand(END_THREAD, (void *)0); }  // MessageLoggerQ::END()

void MessageLoggerQ::MLqSHT() { simpleCommand(SHUT_UP, (void *)0); }  // MessageLoggerQ::SHT()
...
void MessageLoggerQ::MLqSUM() { simpleCommand(SUMMARIZE, 0); }  // MessageLoggerQ::SUM()
