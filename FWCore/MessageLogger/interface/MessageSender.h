...
//                      The custom deleter takes over the function of the message sending from the
//                      MessageSender destructor.
//                      This allows MessageSender to be copyable, which fixes the clang compilation
//                      errors.
...
namespace edm {
  ...
  public:
    ...
    MessageSender(ELseverityLevel const& sev, ELstring const& id, bool verbatim = false,
