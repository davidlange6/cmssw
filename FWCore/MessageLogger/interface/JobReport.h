  ...
  public:
    ...
    */
    ...
    struct JobReportImpl {
       ...
       *
       */
      void associateLumiSection(JobReport::Token token, unsigned int runNumber,
                                unsigned int lumiSection, unsigned long nEvents);
    ...
    /// of this file.
    Token inputFileOpened(std::string const& physicalFileName, std::string const& logicalFileName,
    ...
    /// The returned Token should be used for later identification
    /// of this file.
    Token outputFileOpened(std::string const& physicalFileName, std::string const& logicalFileName,
    ...
    void reportFallbackAttempt(std::string const& pfn, std::string const& lfn,
    ...
    void reportFastClonedBranches(std::set<std::string> const& fastClonedBranches,
                                  long long nEvents);
    ...
    void reportPerformanceForModule(std::string const& metricClass, std::string const& moduleName,
                                    std::map<std::string, std::string> const& metrics);
