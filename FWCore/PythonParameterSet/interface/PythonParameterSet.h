...
public:
  ...
  PythonParameterSet(edm::ParameterSet const& p) : theParameterSet(p) {}
  ...
  edm::InputTag newInputTag(std::string const& label, std::string const& instance,
  ...
  edm::EventID newEventID(edm::RunNumber_t run, edm::LuminosityBlockNumber_t lumi,
  ...
  edm::EventRange newEventRange(edm::RunNumber_t start, edm::LuminosityBlockNumber_t startLumi,
                                edm::EventNumber_t startSub, edm::RunNumber_t end,
                                edm::LuminosityBlockNumber_t endLumi, edm::EventNumber_t endSub) {
