...
BOOST_PYTHON_MODULE(libFWCorePythonParameterSet) {
  boost::python::register_exception_translator<cms::Exception>(
      translatorlibFWCorePythonParameterSet);
  ...
  boost::python::class_<edm::ESInputTag>("ESInputTag", boost::python::init<std::string>())
      .def(boost::python::init<std::string, std::string>())
      .def("module", &edm::ESInputTag::module,
           boost::python::return_value_policy<boost::python::copy_const_reference>())
      .def("data", &edm::ESInputTag::data,
           boost::python::return_value_policy<boost::python::copy_const_reference>());

  boost::python::class_<edm::EventID>(
      "EventID",
      boost::python::init<edm::RunNumber_t, edm::LuminosityBlockNumber_t, edm::EventNumber_t>())
      .def("run", &edm::EventID::run)
      .def("luminosityBlock", &edm::EventID::luminosityBlock)
      .def("event", &edm::EventID::event);

  boost::python::class_<edm::LuminosityBlockID>("LuminosityBlockID",
  ...
  boost::python::class_<edm::LuminosityBlockRange>(
      "LuminosityBlockRange",
      boost::python::init<unsigned int, unsigned int, unsigned int, unsigned int>())
  ...
  boost::python::class_<edm::EventRange>(
      "EventRange",
      boost::python::init<edm::RunNumber_t, edm::LuminosityBlockNumber_t, edm::EventNumber_t,
  ...
  boost::python::class_<PythonParameterSet>("ParameterSet")
      ...
      .def("addVLuminosityBlockRange",
           &PythonParameterSet::addParameters<edm::LuminosityBlockRange>)
      .def("getVLuminosityBlockRange",
           &PythonParameterSet::getParameters<edm::LuminosityBlockRange>)
  ...
  boost::python::class_<PythonProcessDesc>("ProcessDesc", boost::python::init<>())
      ...
      .def("pset", &PythonProcessDesc::pset,
