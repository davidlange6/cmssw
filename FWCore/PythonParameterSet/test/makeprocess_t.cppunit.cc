...
void testmakeprocess::taskTest() {
  ...
  CPPUNIT_ASSERT(
      !test->existsAs<edm::ParameterSet>("m1") && !test->existsAs<edm::ParameterSet>("m2") &&
  ...
  CPPUNIT_ASSERT(
      !test->existsAs<edm::ParameterSet>("f1") && !test->existsAs<edm::ParameterSet>("f2") &&
  ...
  CPPUNIT_ASSERT(
      !test->existsAs<edm::ParameterSet>("a1") && !test->existsAs<edm::ParameterSet>("a2") &&
  ...
  CPPUNIT_ASSERT(
      !test->existsAs<edm::ParameterSet>("o1") && !test->existsAs<edm::ParameterSet>("o2") &&
  ...
  for (auto const& pset : vpsetServices) {
    ...
    // std::cout << "serviceName = " << pset.getParameter<std::string>("@service_type") <<
    // std::endl;
  }
...
void testmakeprocess::taskTestWithSchedule() {
  ...
  CPPUNIT_ASSERT(
      test->existsAs<edm::ParameterSet>("ess@ess1") && test->existsAs<edm::ParameterSet>("ess2@") &&
  ...
  CPPUNIT_ASSERT(
      test->existsAs<edm::ParameterSet>("esp@esp1") && test->existsAs<edm::ParameterSet>("esp2@") &&
