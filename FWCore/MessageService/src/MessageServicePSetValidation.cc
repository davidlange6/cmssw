...
namespace edm {
  namespace service {
    ...
    void edm::service::MessageServicePSetValidation::messageLoggerPSet(ParameterSet const& pset) {
      ...
      std::string dumps =
          check<std::string>(pset, "MessageLogger", "generate_preconfiguration_message");
    ...
    void edm::service::MessageServicePSetValidation::noDuplicates(
        vString const& v, std::string const& psetName, std::string const& parameterLabel) {
    ...
    void edm::service::MessageServicePSetValidation::catBoolRestriction(
        ParameterSet const& pset, std::string const& psetName, std::string const& categoryName,
        std::string const& type) {
