...
namespace edmtest {
  ...
  void UTC_Vd1::analyze(edm::Event const& /*unused*/
    ...
    edm::LogWarning("cat_A") << "T1 analyze warning with identifier " << identifier << " event "
                             << ev;
  ...
  void UTC_Vd1::beginJob() {
    edm::LogWarning("cat_BJ") << "T1 beginJob warning with identifier " << identifier << " event "
                              << ev;
  ...
  void UTC_Vd1::beginLuminosityBlock(edm::LuminosityBlock const& /*unused*/,
                                     edm::EventSetup const& /*unused*/) {
    edm::LogWarning("cat_BL") << "T1 beginLumi warning with identifier " << identifier << " event "
                              << ev;
